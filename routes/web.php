...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/mensagens/poll', [MessageController::class, 'poll'])->name('messages.poll');
    Route::get('/mensagens/stream', [MessageController::class, 'stream'])->name('messages.stream');
    Route::post('/mensagens', [MessageController::class, 'store'])->name('messages.store');
    Route::get('/mensagens/{message}/anexo', [MessageController::class, 'downloadAttachment'])->name('messages.attachments.download');
